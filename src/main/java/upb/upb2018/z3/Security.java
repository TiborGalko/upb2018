...
import static upb.upb2018.z3.BytesToHex.bytesToHex;
...
public class Security {
    ...
    protected static Boolean checkParamsOfPassword(String password){
        ...
        //System.out.println("bigAlphaInside = " + bigAlphaInside(password));
        //System.out.println("littleAlphaInside = " + littleAlphaInside(password));
        //System.out.println("numberInside = " + numberInside(password));
        //System.out.println("weightInside = " + weightInside(password, minLength));
    ...
    protected static Boolean checkDict(String password) throws FileNotFoundException, IOException {
        ...
        DictionaryRule rule = new DictionaryRule(
            ...
            new FileReader[] {new FileReader("passwords.txt")},
